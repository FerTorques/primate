...
class Pregunta(models.Model):
	...
	texto = models.TextField(verbose_name='Dice la pregunta')
	max_puntaje = models.DecimalField(verbose_name='Maximo Puntaje', default=130, decimal_places=2, max_digits=6)
...
class ElegirRespuesta(models.Model):
	...
	correcta = models.BooleanField(verbose_name='Cual es la respuesta correcta?', default=False, null=False)
	texto = models.TextField(verbose_name='Dice la respuesta')
